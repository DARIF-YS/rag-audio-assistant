...
This project demonstrates the creation of a **Retrieval-Augmented Generation (RAG) chatbot for audio question-answering**.  
It allows users to **upload an audio or video file**, **transcribe and index its content**, and then **ask questions about the content** with **context-aware answers** generated by a language model.
